...
class TokenCipher:
    def __init__(self, key: str | bytes):
        ...
        try:
            ...
            raise TokenCipherError(
                "invalid NEXUS_TOKEN_KEY — must be a urlsafe-base64 32-byte Fernet "
    ...
    def decrypt(self, ciphertext: str) -> str:
        try:
            ...
            raise TokenCipherError(
                "could not decrypt a stored token — the NEXUS_TOKEN_KEY may have "
                "changed since it was written"
            ) from e

    @staticmethod
    def generate_key() -> str:
        """A fresh Fernet key — put this in NEXUS_TOKEN_KEY."""
