...
from anvay.api.deps import get_auth_store, get_registry
from anvay.auth.store import CSRF_COOKIE, SESSION_COOKIE, SESSION_TTL_DAYS, AuthError, AuthStore
...
def _secure_cookie(request: Request) -> bool:
    if (os.getenv("ANVAY_ENV") or "").strip().lower() == "production":
        return True
